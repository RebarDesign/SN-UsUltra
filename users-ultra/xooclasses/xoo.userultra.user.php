...

	{
...

		{
...

			{
					...
					$html = "<div class='uupublic-ultra-success'>".__(" Success!! The new password has been sent to ".$user_email." Please refresh and login again with your new password  ", 'xoousers')."</div>";
					...
					$html = "<p>There is a problem with your user account</p>";
					die();				
...

	{
...

		{
...

			{
				...
				$url = '<a class="uultra-btn-u-menu" href="?module=wootracker"><span><i class="fa fa-truck   fa-2x"></i></span>'.__('My Top Ups', 'xoousers').'</a>';	
				...
				$url = '<a class="uultra-btn-u-menu" href="?page_id='.$_GET["page_id"].'&module=wootracker"><span><i class="fa fa-truck   fa-2x"></i></span>'.__('My Top Ups', 'xoousers').'</a>';			
...

			{
				...
				$url = '<a class="uultra-btn-u-menu" href="?module=myorders"><span><i class="fa fa-list   fa-2x"></i></span>'.__('My Courses', 'xoousers').'</a>';	
				...
				$url = '<a class="uultra-btn-u-menu" href="?page_id='.$_GET["page_id"].'&module=myorders"><span><i class="fa fa-list   fa-2x"></i></span>'.__('My Courses', 'xoousers').'</a>';			
			...
			if ( in_array( 'student', $rd_current_user->roles )){  
...

				{
					...
					$url = '<a class="uultra-btn-u-menu" href="?module=friends"><span><i class="fa fa-users fa-2x"></i></span>'.__('My Tutors', 'xoousers').'</a>';	
					...
					$url = '<a class="uultra-btn-u-menu" href="?page_id='.$_GET["page_id"].'&module=friends"><span><i class="fa fa-users fa-2x"></i></span>'.__('My Tutors', 'xoousers').'</a>';			
...

				{
					...
					$url = '<a class="uultra-btn-u-menu" href="?module=friends"><span><i class="fa fa-users fa-2x"></i></span>'.__('My Students', 'xoousers').'</a>';	
					...
					$url = '<a class="uultra-btn-u-menu" href="?page_id='.$_GET["page_id"].'&module=friends"><span><i class="fa fa-users fa-2x"></i></span>'.__('My Students', 'xoousers').'</a>';			
...

			{
				...
				$url .= '<div class="uultra-noti-bubble" title="'.__('Requests', 'xoousers').'">'.$total.'</div>';
...

			{
				...
				$url = '<a class="uultra-btn-u-menu" href="?module=posts"><span><i class="fa fa-edit fa-2x"></i></span>'.__('My Tutoring', 'xoousers').'</a>';	
				...
				$url = '<a class="uultra-btn-u-menu" href="?page_id='.$_GET["page_id"].'&module=posts"><span><i class="fa fa-edit fa-2x"></i></span>'.__('My Tutoring', 'xoousers').'</a>';			
	...
	******************************************/
...

	{
        ...
        $display.=$xoouserultra->htmlbuilder->button('submit', array(
                    ...
                    'class' => 'uultra-button-alt btn uultra-search-submit',
